...
// How to run on nene:
//
// $time /Users/hyoklee/src/spark-2.3.0-SNAPSHOT-bin-hdf5s-0.0.1/bin/spark-shell -i parquet_read.scala --driver-memory 1G --executor-memory 1G --master spark://nene.ad.hdfgroup.org:7077

import org.apache.spark.sql.expressions.Window
import org.apache.spark.sql.functions._

val sqlContext = new org.apache.spark.sql.SQLContext(sc)
val df = spark.read.parquet("/tmp/parquet/test_table")
